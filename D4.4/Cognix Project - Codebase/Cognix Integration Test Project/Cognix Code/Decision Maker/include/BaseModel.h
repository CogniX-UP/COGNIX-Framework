...
namespace DecisionMaking {
	...
	*/
	...
	public:
		...
		*/
		virtual void Train(std::vector<double>& observations, size_t featureSize, std::vector<size_t>& labels, size_t numClasses) = 0;
		/**
		...
		*/
		virtual double CrossValidate(size_t k, std::vector<double>& observations, size_t featureSize, std::vector<size_t> &labels, size_t numClasses, Metric metric) = 0;
	private:
